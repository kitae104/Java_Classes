...
public class CjOcr3 {
    ...
    public CjOcr3(String ocrString) {
    ...
    private String getMemo(){
        ...
        int endPosition = findPosition(words, "Box수량");
        for(int i = startPosition+1; i < endPosition-5; i++){
            memo += words[i];
        }
    ...
    private AddressEntity getAddressEntity(){
        ...
        String address = "";
        int startPosition = findPosition(words, "바랍니다.");
        int endPosition = findPosition(words, "[송도동");       // 바람직 하지 않음!!
